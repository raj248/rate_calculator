  ...
  return (
    <View className="p-2">
      ...
      <View className="flex-row border-b border-gray-400 pb-1 mb-1">
        <Text style={{ fontSize: textSize }} className="w-14 font-bold text-center">Date</Text>
        <Text style={{ fontSize: textSize }} className="w-18 font-bold text-center">Day</Text>
        <Text style={{ fontSize: textSize }} className="w-14 font-bold text-center">₹ 2.5</Text>
        <Text style={{ fontSize: textSize }} className="w-14 font-bold text-center">₹ 2</Text>
      ...
      {recordedDays.map((day, index) => {
        ...
        return (
          <View key={index} className="flex-row border-b border-gray-200 py-1">
            <Text style={{ fontSize: textSize }} className="w-14 text-center">{formattedDate}</Text>
            <Text style={{ fontSize: textSize }} className="w-18 text-center">{dayName}</Text>
            <Text style={{ fontSize: textSize }} className="w-14 text-center">{amt1}</Text>
            <Text style={{ fontSize: textSize }} className="w-14 text-center">{amt2}</Text>
            <Text style={{ fontSize: textSize }} className="flex-1 text-center">{dayTotal}</Text>
          </View>
        );
      })}
